...
from .base import TorchCompatibleShrinkedCandleModel


class TCsC_Transformer(TorchCompatibleShrinkedCandleModel):
    def __init__(
        self,
        input_horizon: int,
        output_horizon: int,
        ...
        model = CandleTransformer(num_features=3, output_horizon=output_horizon)
        super().__init__(
            model,
            input_horizon,
            output_horizon,
